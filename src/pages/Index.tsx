  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: backgroundGradient }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 pt-20">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 min-h-[80vh] px-4">
          {/* Main Timer Section */}
          <div className="transform sm:scale-100 md:scale-125 w-full md:w-auto flex flex-col items-center justify-center">
            <div className="flex justify-center mb-8 gap-3 flex-wrap">
              {TIMER_PRESETS.map((preset) => (
                <button
                  key={preset.label}
                  onClick={() => setSelectedPreset(preset)}
                  className={`px-6 py-2 md:px-8 md:py-3 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 mb-4 md:mb-8 ${
          ...
          {/* Session History */}
          <div className="w-full md:w-80 glass-morphism rounded-xl p-4 flex flex-col min-h-[300px] md:min-h-[500px] max-h-[calc(100vh-4rem)]">
